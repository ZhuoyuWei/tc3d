...
def train(input_dir, ground_truth_dir, model_file):
    ...
    lm_x = MLPRegressor(hidden_layer_sizes=(100,50), max_iter=3)
    ...
    lm_y = MLPRegressor(hidden_layer_sizes=(100,50), max_iter=3)
    ...
    lm_z = MLPRegressor(hidden_layer_sizes=(100,50), max_iter=3)
    ...
    lm_s = MLPRegressor(hidden_layer_sizes=(100,50), max_iter=3)
